<div>
    <div class="card">
        <h3 id="card_one" class="card-header" align="center"><b>FORMULIR SEKAGUS PELAYANAN POLI NYERI</b></h3>
        <div class="card-body">
            <div class="card">
                    ...
                    <form>
                        ...
                        <table border="0" width="100%" class="table">
                            <tr>
                                ...
                                <td width="1%">:</td>
                                <td>ada <input type="checkbox" name=""> tidak ada <input type="checkbox" name=""></td>
                            </tr>
                            <tr>
                                <td align="right">b.</td>
                        ...
                        <table border="1" width="100%" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai1" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai2" value="75" onclick="hitung()"> 1 orang <input type="checkbox" id="nilai3" value="100" onclick="hitung()"> >1 orang</td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai4" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai5" value="75" onclick="hitung()"> 1 orang <input type="checkbox" id="nilai6" value="100" onclick="hitung()"> >1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai7" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai8" value="75" onclick="hitung()"> 1 orang <input type="checkbox" id="nilai9" value="100" onclick="hitung()"> >1 orang</td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai10" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai11" value="75" onclick="hitung()"> 1 orang <input type="checkbox" id="nilai12" value="100" onclick="hitung()"> >1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai13" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai14" value="75" onclick="hitung()"> 1 orang <input type="checkbox" id="nilai15" value="100" onclick="hitung()"> >1 orang</td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai16" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai17" value="75" onclick="hitung()"> 1 orang <input type="checkbox" id="nilai18" value="100" onclick="hitung()"> >1 orang</td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai19" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai20" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai21" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai22" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai23" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai24" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai25" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai26" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai27" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai28" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai29" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai30" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">2%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai31" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai32" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai33" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai34" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai35" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai36" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai37" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai38" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai39" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai40" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai41" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai42" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">2%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai43" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai44" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                        ...
                        <table border="1" width="100%" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai45" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai46" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai47" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai48" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">25%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai49" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai50" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">25%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai51" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai52" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">25%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai53" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai54" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai55" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai56" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai57" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai58" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai59" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai60" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai61" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai62" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai63" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai64" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai65" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai66" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai67" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai68" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai69" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai70" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai71" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai72" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai73" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai74" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai75" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai76" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai77" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai78" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai79" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai80" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai81" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai82" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai83" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai84" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai85" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai86" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai87" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai88" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">10%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai89" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai90" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai91" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai92" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai93" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai94" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai95" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai96" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai97" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai98" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai99" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai100" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai101" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai102" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai103" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai104" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai105" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai106" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai107" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai108" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai109" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai110" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai111" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai112" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai113" value="50" onclick="hitung()">
                                        < 3 orang <input type="checkbox" id="nilai114" value="75" onclick="hitung()"> 3 -5 orang <input type="checkbox" id="nilai115" value="100" onclick="hitung()"> >5 orang
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai116" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai117" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai118" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai119" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">17%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai120" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai121" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">16%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai122" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai123" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">17%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%"><input type="checkbox" id="nilai124" value="0" onclick="hitung()"> tidak ada <input type="checkbox" id="nilai125" value="100" onclick="hitung()"> 1 orang</td>
                                    <td></td>
                                    <td align="center">17%</td>
