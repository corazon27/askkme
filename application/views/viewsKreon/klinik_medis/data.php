            ...
            <div class="row">
                <div class="col">
                    <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                        Data Kredensialing Tenaga Medis Klinik Utama
                    </h4>
                </div>
                <div class="col-auto">
                    <a href="<?= base_url('me/import/klinik') ?>" class="btn btn-sm btn-primary  btn-icon-split">
                        <span class="icon">
                ...
                <div class="col-auto">
                    <a href="<?= base_url('me/klinik_tm/add') ?>" class="btn btn-sm btn-primary  btn-icon-split">
                        <span class="icon">
                            <i class="fa fa-plus"></i>
                        </span>
                        <span class="text">
                            Tambah Klinik Tenaga Medis
                        </span>
                    </a>
                </div>
            </div>
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?= $ktm['jkn_kis']; ?></td>
                                <td><a href="<?= base_url('upload/klinik/' . $ktm['dokumen2']) ?>" class="btn btn-primary btn-sm m-b-10 m-l-5" target="_blank">PDF</a></td>
                                ...
                                <td><?= $masa_aktif ?></td>
                                <td><?= $hasil ?></td>
                                <td><a href="<?= base_url('upload/klinik/' . $ktm['dokumen']) ?>" class="btn btn-primary btn-sm m-b-10 m-l-5" target="_blank">PDF</a></td>
                                <td><?php
                                    ...
                                    ?> </td>
                                <td>
                                    <a class="btn btn-success btn-sm mb-2 text-light" data-toggle="modal" data-target="#modalPenilaian<?= $ktm['id_klinik_tm'] ?>" title="Penilaian"><i class="fa fa-book"></i> Hasil Penilaian</a>
                                </td>
                                ...
                                <?php } elseif ($ktm['status_penilaian'] == 1) { ?>
                                    <td>
                                        <?php if (is_admin()) : ?>
                                            <a href="<?= base_url('me/klinik_tm/stj/') . $ktm['id_klinik_tm'] . '/' . $ktm['id_telegram'] ?>" class="btn btn-warning btn-circle btn-sm" title="Kirim Pesan"><i class="fas fa-paper-plane"></i></a>
                                        <?php endif; ?>
                                    </td>
                                <?php } elseif ($ktm['status_penilaian'] == 2) { ?>
                                    <td>
                                        <?php if (is_admin()) : ?>
                                            <a href="<?= base_url('me/klinik_tm/tlk/') . $ktm['id_klinik_tm'] . '/' . $ktm['id_telegram'] ?>" class="btn btn-warning btn-circle btn-sm" title="Kirim Pesan"><i class="fas fa-paper-plane"></i></a>
                                        <?php endif; ?>
                                        <a href="<?= base_url('me/klinik_tm/edit/') . $ktm['id_klinik_tm'] ?>" class="btn btn-warning btn-circle btn-sm" title="Edit Data"><i class="fa fa-edit"></i></a>
                                        <a onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('me/klinik_tm/delete/') . $ktm['id_klinik_tm'] ?>" class="btn btn-danger btn-circle btn-sm" title="Hapus Data"><i class="fa fa-trash"></i></a>
                                    </td>
                                <?php } ?>
                            </tr>
                            <?php ?>
...
<!-- modal -->
<?php foreach ($klinik_tm2 as $ktm) { ?>
    <div class="modal fade" id="modalPenilaian<?= $ktm['id_klinik_tm'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('me/klinik_tm/status/') . $ktm['id_klinik_tm'] ?>" method="post">
