    ...
    <div class="col-11">
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header">
                <h5 id="card_one" class="card-header font-weight-bold"><i class="fas fa-book"></i><span> Form Input Data Kredensialing Klinik Utama</span>
                    <h5>
                        <?= $this->session->flashdata('pesan'); ?>
                        <?php unset($_SESSION['pesan']); ?>
                        <form method="POST" action="<?= site_url('me/klinik_tm/add') ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row form-group">
                                            <?php if ($this->session->login_session['role'] == "faskes") { ?>
                                                ...
                                                <label class="col-md-3 text-md-right" for="sisa_hari">Nama Faskes</label>
                                                <div class="col-md-9">
                                            ...
                                            <?php } else { ?>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <select name="id_nama_faskes" id="nama" class="custom-select">
                                        ...
                                        <div class="row form-group">
                                            <label class="col-md-3 text-md-right" for="">Dokumen JKN-KIS</label>
                                            <div class="col-md-9">
                                                <input type="file" name="dokumen2" size="20" class="form-control" />
