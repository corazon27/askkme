        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('me/optik_dokumen') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <?= form_open('', [], ['id_optik_doc' => $optik_doc['id_optik_doc']]); ?>
                    <input value="<?= set_value('id_optik_doc', $optik_doc['id_optik_doc']); ?>" name="id_optik_doc" id="id_optik_doc" type="hidden" class="form-control" placeholder="Nama Faskes...">
                    <?= form_error('id_optik_doc', '<small class="text-danger">', '</small>'); ?>
                    <?php if (is_faskes()) { ?>
                                ...
                                <div class="input-group">
                                    <select name="id_nama_faskes" id="id_nama_faskes" class="custom-select">
                                        ...
                                        <?php foreach ($nama_faskes as $nf) : ?>
                                            <option <?= $optik_doc['id_nama_faskes'] == $nf['id_nama_faskes'] ? 'selected' : ''; ?> <?= set_select('id_nama_faskes', $nf['id_nama_faskes']) ?> value="<?= $nf['id_nama_faskes'] ?>"><?= $nf['nama_faskes'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <?= form_error('id_nama_faskes', '<small class="text-danger">', '</small>'); ?>
                            ...
                            <div class="input-group">
                                <select name="id_nama_surat" id="id_nama_surat" class="custom-select">
                                    ...
                                    <?php foreach ($nama_surat as $ns) : ?>
                                        <option <?= $optik_doc['id_nama_surat'] == $ns['id_nama_surat'] ? 'selected' : ''; ?> <?= set_select('id_nama_surat', $ns['id_nama_surat']) ?> value="<?= $ns['id_nama_surat'] ?>"><?= $ns['nama_surat'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('nomor_surat', $optik_doc['nomor_surat']); ?>" name="nomor_surat" id="nomor_surat" type="text" class="form-control" placeholder="Nomor Surat...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('tmt', $optik_doc['tmt']); ?>" name="tmt" id="tmt" type="date" class="form-control" placeholder="TMT...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('tat', $optik_doc['tat']); ?>" name="tat" id="tat" type="date" class="form-control" placeholder="TAT...">
                            <?= form_error('tat', '<small class="text-danger">', '</small>'); ?>
                        </div>
                    </div>

                    <div class="row form-group">
                        <label class="col-md-3 text-md-right" for="sisa_hari">Sisa Hari</label>
                        <div class="col-md-9">
                            <input value="<?= set_value('sisa_hari', $optik_doc['sisa_hari']); ?>" readonly name="sisa_hari" id="sisa" type="text" class="form-control" placeholder="Sisa Hari...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input readonly="" type="text" value="<?= set_value('dokumen', $optik_doc['dokumen']); ?>" name="dokumen" id="dokumen" class="form-control" placeholder="dokumen">
                        </div>
                    </div>
