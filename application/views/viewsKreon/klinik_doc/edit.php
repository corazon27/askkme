        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <?= form_open('', [], ['id_klinik_doc' => $klinik_doc['id_klinik_doc']]); ?>
                    <input value="<?= set_value('id_klinik_doc', $klinik_doc['id_klinik_doc']); ?>" name="id_klinik_doc" id="id_klinik_doc" type="hidden" class="form-control" placeholder="Nama Faskes...">
                    <?= form_error('id_klinik_doc', '<small class="text-danger">', '</small>'); ?>
                    <?php if (is_faskes()) { ?>
                                ...
                                <div class="input-group">
                                    <select name="id_nama_faskes" id="id_nama_faskes" class="custom-select">
                                        ...
                                        <?php foreach ($nama_faskes as $nf) : ?>
                                            <option <?= $klinik_doc['id_nama_faskes'] == $nf['id_nama_faskes'] ? 'selected' : ''; ?> <?= set_select('id_nama_faskes', $nf['id_nama_faskes']) ?> value="<?= $nf['id_nama_faskes'] ?>"><?= $nf['nama_faskes'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <?= form_error('id_nama_faskes', '<small class="text-danger">', '</small>'); ?>
                            ...
                            <div class="input-group">
                                <select name="id_nama_surat" id="id_nama_surat" class="custom-select">
                                    ...
                                    <?php foreach ($nama_surat as $ns) : ?>
                                        <option <?= $klinik_doc['id_nama_surat'] == $ns['id_nama_surat'] ? 'selected' : ''; ?> <?= set_select('id_nama_surat', $ns['id_nama_surat']) ?> value="<?= $ns['id_nama_surat'] ?>"><?= $ns['nama_surat'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('nomor_surat', $klinik_doc['nomor_surat']); ?>" name="nomor_surat" id="nomor_surat" type="text" class="form-control" placeholder="Nomor Surat...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('tmt', $klinik_doc['tmt']); ?>" name="tmt" id="tmt" type="date" class="form-control" placeholder="TMT...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('tat', $klinik_doc['tat']); ?>" name="tat" id="tat" type="date" class="form-control" placeholder="TAT...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('sisa_hari', $klinik_doc['sisa_hari']); ?>" readonly name="sisa_hari" id="sisa" type="text" class="form-control" placeholder="Sisa Hari...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input readonly="" type="text" value="<?= set_value('dokumen', $klinik_doc['dokumen']); ?>" name="dokumen" id="dokumen" class="form-control" placeholder="dokumen">
                        </div>
                    </div>
