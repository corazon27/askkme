        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('me/optik_tm') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <form method="POST" action="" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <?= form_open('', [], ['id_optik_tm' => $optik_tm['id_optik_tm']]); ?>
                    <input value="<?= set_value('id_optik_tm', $optik_tm['id_optik_tm']); ?>" name="id_optik_tm" id="id_optik_tm" type="hidden" class="form-control" placeholder="Nama Faskes...">
                    <?= form_error('id_optik_tm', '<small class="text-danger">', '</small>'); ?>
                    <?php if (is_faskes()) { ?>
                                ...
                                <div class="input-group">
                                    <select name="id_nama_faskes" id="id_nama_faskes" class="custom-select">
                                        ...
                                        <?php foreach ($nama_faskes as $nf) : ?>
                                            <option <?= $optik_tm['id_nama_faskes'] == $nf['id_nama_faskes'] ? 'selected' : ''; ?> <?= set_select('id_nama_faskes', $nf['id_nama_faskes']) ?> value="<?= $nf['id_nama_faskes'] ?>"><?= $nf['nama_faskes'] ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <?= form_error('id_nama_faskes', '<small class="text-danger">', '</small>'); ?>
                            ...
                            <div class="input-group">
                                <select name="id_jns_tng_mds" id="id_jns_tng_mds" class="custom-select">
                                    ...
                                    <?php foreach ($jns as $js) : ?>
                                        <option <?= $optik_tm['id_jns_tng_mds'] == $js['id_jns_tng_mds'] ? 'selected' : ''; ?> <?= set_select('id_jns_tng_mds', $js['id_jns_tng_mds']) ?> value="<?= $js['id_jns_tng_mds'] ?>"><?= $js['jenis_tenaga_medis'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('nama_tng_mds', $optik_tm['nama_tng_mds']); ?>" name="nama_tng_mds" id="nama_tng_mds" type="text" class="form-control" placeholder="Nama Tenaga Medis...">
                    ...
                    <div class="row form-group">
                        ...
                        <label for="jkn_kis_1" id="jkn1" class="kis1">
                            <?php echo form_radio('jkn_kis', "Ya", set_checkbox('jkn_kis', "Ya", $optik_tm['jkn_kis'] == 'Ya' ? true : false), "id='jkn_kis_1'"); ?> Ya </label>
                        <label for="jkn_kis_2" id="jkn2" class="kis2">
                            <?php echo form_radio('jkn_kis', "Tidak", set_checkbox('jkn_kis', "Tidak", $optik_tm['jkn_kis'] == 'Tidak' ? true : false), "id='jkn_kis_1'"); ?> Tidak </label>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input readonly="" type="text" value="<?= set_value('dokumen2', $optik_tm['dokumen2']); ?>" name="dokumen2" id="dokumen2" class="form-control" placeholder="Dokumen JKN-KIS">
                        </div>
                    </div>
                            ...
                            <div class="input-group">
                                <select name="id_nama_surat" id="id_nama_surat" class="custom-select">
                                    ...
                                    <?php foreach ($nama_surat as $ns) : ?>
                                        <option <?= $optik_tm['id_nama_surat'] == $ns['id_nama_surat'] ? 'selected' : ''; ?> <?= set_select('id_nama_surat', $ns['id_nama_surat']) ?> value="<?= $ns['id_nama_surat'] ?>"><?= $ns['nama_surat'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <?= form_error('id_nama_faskes', '<small class="text-danger">', '</small>'); ?>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('nomor_surat', $optik_tm['nomor_surat']); ?>" name="nomor_surat" id="nomor_surat" type="text" class="form-control" placeholder="Nomor Surat...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('tmt', $optik_tm['tmt']); ?>" name="tmt" id="tmt" type="date" class="form-control" placeholder="TMT...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('tat', $optik_tm['tat']); ?>" name="tat" id="tat" type="date" class="form-control" placeholder="TAT...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input value="<?= set_value('sisa_hari', $optik_tm['sisa_hari']); ?>" readonly name="sisa_hari" id="sisa" type="text" class="form-control" placeholder="Sisa Hari...">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input readonly="" type="text" value="<?= set_value('dokumen', $optik_tm['dokumen']); ?>" name="dokumen" id="dokumen" class="form-control" placeholder="dokumen">
                        </div>
                    </div>
