    ...
    <div class="col-11">
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header">
                <h5 id="card_one" class="card-header font-weight-bold"><i class="fas fa-book"></i><span> Form Input Data Kredensialing Optik</span>
                    <h5>
                        <?= $this->session->flashdata('pesan'); ?>
                        <?php unset($_SESSION['pesan']); ?>
                        <form method="POST" action="<?= site_url('me/optik_tm/add') ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="card">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input value="<?= set_value('sisa_hari'); ?>" name="sisa_hari" readonly id="sisa" type="text" class="form-control" placeholder="Masukkan sisa hari">
