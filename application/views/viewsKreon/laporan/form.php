        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                    Form Laporan Kredensialing Rumah Sakit
                </h4>
            </div>
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="custom-control custom-radio">
                            <input value="kreon_tm" type="radio" id="kreon_tm" name="transaksi" class="custom-control-input">
                            <label class="custom-control-label" for="kreon_tm">Kredensialing Tenaga Medis</label>
                        </div>
                        <div class="custom-control custom-radio">
