            ...
            <div class="row">
                <div class="col">
                    <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                        Data Dokumen Rumah Sakit
                    </h4>
                </div>
                <div class="col-auto">
                    <a href="<?= base_url('me/import/dok') ?>" class="btn btn-sm btn-primary  btn-icon-split">
                        <span class="icon">
                            <i class="fa fa-plus"></i>
                        </span>
                        <span class="text">
                            Tambah Excel Dokumen RS
                        </span>
                    </a>
                </div>
                <div class="col-auto">
                    <a href="<?= base_url('me/rs_dokumen/add') ?>" class="btn btn-sm btn-primary  btn-icon-split">
                        <span class="icon">
                            <i class="fa fa-plus"></i>
                        </span>
                        <span class="text">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?= $masa_aktif ?></td>
                                <td><?= $hasil ?></td>
                                <td><a href="<?= base_url('upload/dokumen/' . $kd['dokumen']) ?>" class="btn btn-primary btn-sm m-b-10 m-l-5" target="_blank">PDF</a></td>
                                <td><?php
                                    ...
                                    ?> </td>
                                <td>
                                    <a class="btn btn-success btn-sm mb-2 text-light" data-toggle="modal" data-target="#modalPenilaian<?= $kd['id_kreon_doc'] ?>" title="Penilaian"><i class="fa fa-book"></i> Hasil Penilaian</a>
                                </td>
                                ...
                                <?php } elseif ($kd['status_penilaian'] == 1) { ?>
                                    <td>
                                        <?php if (is_admin()) : ?>
                                            <a href="<?= base_url('me/rs_dokumen/stj/') . $kd['id_kreon_doc'] . '/' . $kd['id_telegram'] ?>" class="btn btn-warning btn-circle btn-sm" title="Kirim Pesan"><i class="fas fa-paper-plane"></i></a>
                                        <?php endif; ?>
                                    </td>
                                <?php } elseif ($kd['status_penilaian'] == 2) { ?>
                                    <td>
                                        <?php if (is_admin()) : ?>
                                            <a href="<?= base_url('me/rs_dokumen/tlk/') . $kd['id_kreon_doc'] . '/' . $kd['id_telegram'] ?>" class="btn btn-warning btn-circle btn-sm" title="Kirim Pesan"><i class="fas fa-paper-plane"></i></a>
                                        <?php endif; ?>
                                        <a href="<?= base_url('me/rs_dokumen/edit/') . $kd['id_kreon_doc'] ?>" class="btn btn-warning btn-circle btn-sm" title="Edit Data"><i class="fa fa-edit"></i></a>
                                        <a onclick="return confirm('Yakin ingin hapus?')" href="<?= base_url('me/rs_dokumen/delete/') . $kd['id_kreon_doc'] ?>" class="btn btn-danger btn-circle btn-sm" title="Hapus Data"><i class="fa fa-trash"></i></a>
                                    </td>
                                <?php } ?>
                            </tr>
                        <?php endforeach; ?>
...
<!-- modal -->
<?php foreach ($kreon_doc2 as $kd) { ?>
    <div class="modal fade" id="modalPenilaian<?= $kd['id_kreon_doc'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<?= base_url('me/RS_dokumen/status/') . $kd['id_kreon_doc'] ?>" method="post">
