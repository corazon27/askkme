    ...
    <div class="card">
        ...
        if ($this->session->login_session['role'] == 'admin') { ?>
            <?php foreach ($getCheckbox as $cb) : ?>
                <h3 id="card_one" class="card-header" align="center"><b>FORMULIR KREDENSIALING PENGAJUAN <br> PELAYANAN POLI NYERI UNTUK <br> <?= strtoupper($cb['nama_faskes']) ?> </b></h3>
            <?php endforeach; ?>
        ...
        <div class="card-body">
            <div class="card">
                ...
                <div class="card-body">
                    <?php
                    if ($this->session->login_session['role'] == 'admin') { ?>
                        <form method="POST" action="<?= site_url('askk/admin_nyeri/addKredensialing') ?>" enctype="multipart/form-data">
                            <?php foreach ($getCheckbox as $cb) : ?>
                                <input type="text" name="id_checkbox" hidden="" value="<?= $cb['id_checkbox']; ?>">
                            <?php endforeach; ?>
                        <?php } elseif ($this->session->login_session['role'] == 'faskes') { ?>
                            <form method="POST" action="<?= site_url('askk/admin_nyeri/add') ?>" enctype="multipart/form-data">
                                ...
                                <tbody>
                                    <?php foreach ($getCheckbox as $cb) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="input-group input-group-sm mb-3">
                                                    <input type="text" class="form-control" <?= $red ?> value="<?= $cb['nama_pemilik']; ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                ...
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            <!-- <tr>
                                <td colspan="4" align="center">
                                    <h4><b>DOKUMEN SARANA DAN PRASARANA</b></h4>
                                </td>
                                <td>
                    ...
                    <table class="table table-striped">
                        <tr>
                            <td><button id="note_one" onclick="return confirm('Apakah Anda Yakin Ingin menyimpan data dan kirim ? Data tidak bisa dirubah setelah disimpan dan dikirim !')" type="submit" class="btn btn-success">Simpan & Kirim</button></td>
                        </tr>
                    </table>
                    </form>
                </div>
