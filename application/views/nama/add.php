        ...
        <div class="card shadow-sm border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('askk/nama') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <form method="POST" action="<?= base_url('askk/nama/tambahfaskes') ?>" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        <label class="col-md-3 text-md-right" for="nama_fakses">Nama Faskes</label>
                        <div class="col-md-9">
                            <input value="<?= set_value('nama_fakses'); ?>" name="nama_fakses" id="nama_fakses" type="text" class="form-control" placeholder="Nama Faskes...">
                            <?= form_error('nama_fakses', '<small class="text-danger">', '</small>'); ?>
                        </div>
                    </div>
                    <div class="row form-group">
