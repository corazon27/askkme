        ...
        <div class="card shadow-sm mb-4 border-bottom-primary">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('askk/user') ?>" class="btn btn-sm btn-secondary btn-icon-split">
                            <span class="icon">
...
<script language="javascript">
    function passwordChanged() {
        ...
        if (pwd.value.length == 0) {
            strength.innerHTML = '<span id="strength2"><small><i>Harus terdiri dari : Simbol, Huruf kecil-besar, dan Angka</i></small></span>';
    ...
    function passwordChanged2() {
        ...
        if (pwd.value.length == 0) {
            strength2.innerHTML = '<span id="strength2"><small><i>Harus terdiri dari : Simbol, Huruf kecil-besar, dan Angka</i></small></span>';
        } else if (false == enoughRegex.test(pwd.value)) {
