<div>
    <div class="card">
        ...
        <?php if ($this->session->login_session['role'] == 'faskes') { ?>
            <h3 id="card_one" class="card-header" align="center"><b>EDIT FORMULIR PENGAJUAN PELAYANAN POLI NYERI</b></h3>
        <?php } elseif ($this->session->login_session['role'] == 'admin') { ?>
            <h3 id="card_one" class="card-header" align="center"><b> HASIL SELF ASSESMENT <br> PELAYANAN POLI NYERI DARI <?= strtoupper($data->nama_faskes) ?></b></h3>
        <?php } ?>
        <tr>
            ...
            <div class="card">
                ...
                <body onload="hitung()">
                            ...
                            <table border="0" width="100%" class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-group input-group-sm mb-3">
                                                <input type="text" class="form-control" <?= $red ?> value="<?= $data->nama_pemilik ?>" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                    ...
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        ...
                                        <?php $aaa = explode(',', $data->aaa); ?>
                                        <input type="checkbox" id="nilai1" <?= $dis ?> value="0" name="aaa" <?php in_array('0', $aaa) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai2" <?= $dis ?> value="75" name="aaa" <?php in_array('75', $aaa) ? print "checked" : ""; ?> onclick="hitung()"> 1 orang <br>
                                        <input type="checkbox" id="nilai3" <?= $dis ?> value="100" name="aaa" <?php in_array('100', $aaa) ? print "checked" : ""; ?> onclick="hitung()"> >1 orang
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $aab = explode(',', $data->aab); ?>
                                        <input type="checkbox" id="nilai4" <?= $dis ?> value="0" name="aab" <?php in_array('0', $aab) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai5" <?= $dis ?> value="75" name="aab" <?php in_array('75', $aab) ? print "checked" : ""; ?> onclick="hitung()"> 1 orang <br>
                                        <input type="checkbox" id="nilai6" <?= $dis ?> value="100" name="aab" <?php in_array('100', $aab) ? print "checked" : ""; ?> onclick="hitung()"> >1 orang
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $aac = explode(',', $data->aac); ?>
                                        <input type="checkbox" id="nilai7" <?= $dis ?> value="0" name="aac" <?php in_array('0', $aac) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai8" <?= $dis ?> value="75" name="aac" <?php in_array('75', $aac) ? print "checked" : ""; ?> onclick="hitung()"> 1 orang <br>
                                        <input type="checkbox" id="nilai9" <?= $dis ?> value="100" name="aac" <?php in_array('100', $aac) ? print "checked" : ""; ?> onclick="hitung()"> >1 orang
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $aad = explode(',', $data->aad); ?>
                                        <input type="checkbox" id="nilai10" <?= $dis ?> value="0" name="aad" <?php in_array('0', $aad) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai11" <?= $dis ?> value="75" name="aad" <?php in_array('75', $aad) ? print "checked" : ""; ?> onclick="hitung()"> 1 orang <br>
                                        <input type="checkbox" id="nilai12" <?= $dis ?> value="100" name="aad" <?php in_array('100', $aad) ? print "checked" : ""; ?> onclick="hitung()"> >1 orang
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $aae = explode(',', $data->aae); ?>
                                        <input type="checkbox" id="nilai13" <?= $dis ?> value="0" name="aae" <?php in_array('0', $aae) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai14" <?= $dis ?> value="75" name="aae" <?php in_array('75', $aae) ? print "checked" : ""; ?> onclick="hitung()"> 1 orang <br>
                                        <input type="checkbox" id="nilai15" <?= $dis ?> value="100" name="aae" <?php in_array('100', $aae) ? print "checked" : ""; ?> onclick="hitung()"> >1 orang
                                    </td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $aaf = explode(',', $data->aaf); ?>
                                        <input type="checkbox" id="nilai16" <?= $dis ?> value="0" name="aaf" <?php in_array('0', $aaf) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai17" <?= $dis ?> value="75" name="aaf" <?php in_array('75', $aaf) ? print "checked" : ""; ?> onclick="hitung()"> 1 orang <br>
                                        <input type="checkbox" id="nilai18" <?= $dis ?> value="100" name="aaf" <?php in_array('100', $aaf) ? print "checked" : ""; ?> onclick="hitung()"> >1 orang
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $aba = explode(',', $data->aba); ?>
                                        <input type="checkbox" id="nilai19" <?= $dis ?> value="0" name="aba" <?php in_array('0', $aba) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai20" <?= $dis ?> value="100" name="aba" <?php in_array('100', $aba) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $abb = explode(',', $data->abb); ?>
                                        <input type="checkbox" id="nilai21" <?= $dis ?> value="0" name="abb" <?php in_array('0', $abb) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai22" <?= $dis ?> value="100" name="abb" <?php in_array('100', $abb) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                    <td align="center"><input type="text" id="skor8" size="1" readonly=""></td><br>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $abc = explode(',', $data->abc); ?>
                                        <input type="checkbox" id="nilai23" <?= $dis ?> value="0" name="abc" <?php in_array('0', $abc) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai24" <?= $dis ?> value="100" name="abc" <?php in_array('100', $abc) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $abd = explode(',', $data->abd); ?>
                                        <input type="checkbox" id="nilai25" <?= $dis ?> value="0" name="abd" <?php in_array('0', $abd) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai26" <?= $dis ?> value="100" name="abd" <?php in_array('100', $abd) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $abe = explode(',', $data->abe); ?>
                                        <input type="checkbox" id="nilai27" <?= $dis ?> value="0" name="abe" <?php in_array('0', $abe) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai28" <?= $dis ?> value="100" name="abe" <?php in_array('100', $abe) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $abf = explode(',', $data->abf); ?>
                                        <input type="checkbox" id="nilai29" <?= $dis ?> value="0" name="abf" <?php in_array('0', $abf) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai30" <?= $dis ?> value="100" name="abf" <?php in_array('100', $abf) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">2%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $aca = explode(',', $data->aca); ?>
                                        <input type="checkbox" id="nilai31" <?= $dis ?> value="0" name="aca" <?php in_array('0', $aca) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai32" <?= $dis ?> value="100" name="aca" <?php in_array('100', $aca) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $acb = explode(',', $data->acb); ?>
                                        <input type="checkbox" id="nilai33" <?= $dis ?> value="0" name="acb" <?php in_array('0', $acb) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai34" <?= $dis ?> value="100" name="acb" <?php in_array('100', $acb) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $acc = explode(',', $data->acc); ?>
                                        <input type="checkbox" id="nilai35" <?= $dis ?> value="0" name="acc" <?php in_array('0', $acc) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai36" <?= $dis ?> value="100" name="acc" <?php in_array('100', $acc) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $acd = explode(',', $data->acd); ?>
                                        <input type="checkbox" id="nilai37" <?= $dis ?> value="0" name="acd" <?php in_array('0', $acd) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai38" <?= $dis ?> value="100" name="acd" <?php in_array('100', $acd) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $ace = explode(',', $data->ace); ?>
                                        <input type="checkbox" id="nilai39" <?= $dis ?> value="0" name="ace" <?php in_array('0', $ace) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai40" <?= $dis ?> value="100" name="ace" <?php in_array('100', $ace) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $acf = explode(',', $data->acf); ?>
                                        <input type="checkbox" id="nilai41" <?= $dis ?> value="0" name="acf" <?php in_array('0', $acf) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai42" <?= $dis ?> value="100" name="acf" <?php in_array('100', $acf) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">2%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $ca = explode(',', $data->ca); ?>
                                        <input type="checkbox" id="nilai43" <?= $dis ?> value="0" name="ca" <?php in_array('0', $ca) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai44" <?= $dis ?> value="100" name="ca" <?php in_array('100', $ca) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                        ...
                        <table border="1" width="100%" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b1a = explode(',', $data->b1a); ?>
                                        <input type="checkbox" id="nilai45" <?= $dis ?> value="0" name="b1a" <?php in_array('0', $b1a) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai46" <?= $dis ?> value="100" name="b1a" <?php in_array('100', $b1a) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b1b = explode(',', $data->b1b); ?>
                                        <input type="checkbox" id="nilai47" <?= $dis ?> value="0" name="b1b" <?php in_array('0', $b1b) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai48" <?= $dis ?> value="100" name="b1b" <?php in_array('100', $b1b) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">25%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b1c = explode(',', $data->b1c); ?>
                                        <input type="checkbox" id="nilai49" <?= $dis ?> value="0" name="b1c" <?php in_array('0', $b1c) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai50" <?= $dis ?> value="100" name="b1c" <?php in_array('100', $b1c) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">25%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b1d = explode(',', $data->b1d); ?>
                                        <input type="checkbox" id="nilai51" <?= $dis ?> value="0" name="b1d" <?php in_array('0', $b1d) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai52" <?= $dis ?> value="100" name="b1d" <?php in_array('100', $b1d) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">25%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2a = explode(',', $data->b2a); ?>
                                        <input type="checkbox" id="nilai53" <?= $dis ?> value="0" name="b2a" <?php in_array('0', $b2a) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai54" <?= $dis ?> value="100" name="b2a" <?php in_array('100', $b2a) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2b = explode(',', $data->b2b); ?>
                                        <input type="checkbox" id="nilai55" <?= $dis ?> value="0" name="b2b" <?php in_array('0', $b2b) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai56" <?= $dis ?> value="100" name="b2b" <?php in_array('100', $b2b) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2c = explode(',', $data->b2c); ?>
                                        <input type="checkbox" id="nilai57" <?= $dis ?> value="0" name="b2c" <?php in_array('0', $b2c) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada<br>
                                        <input type="checkbox" id="nilai58" <?= $dis ?> value="100" name="b2c" <?php in_array('100', $b2c) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <?php $b2d = explode(',', $data->b2d); ?>
                                    <td width="20%">
                                        <input type="checkbox" id="nilai59" <?= $dis ?> value="0" name="b2d" <?php in_array('0', $b2d) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai60" <?= $dis ?> value="100" name="b2d" <?php in_array('100', $b2d) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <?php $b2e = explode(',', $data->b2e); ?>
                                    <td width="20%">
                                        <input type="checkbox" id="nilai61" <?= $dis ?> value="0" name="b2e" <?php in_array('0', $b2e) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai62" <?= $dis ?> value="100" name="b2e" <?php in_array('100', $b2e) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2f = explode(',', $data->b2f); ?>
                                        <input type="checkbox" id="nilai63" <?= $dis ?> value="0" name="b2f" <?php in_array('0', $b2f) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai64" <?= $dis ?> value="100" name="b2f" <?php in_array('100', $b2f) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2g = explode(',', $data->b2g); ?>
                                        <input type="checkbox" id="nilai65" <?= $dis ?> value="0" name="b2g" <?php in_array('0', $b2g) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai66" <?= $dis ?> value="100" name="b2g" <?php in_array('100', $b2g) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2h = explode(',', $data->b2h); ?>
                                        <input type="checkbox" id="nilai67" <?= $dis ?> value="0" name="b2h" <?php in_array('0', $b2h) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai68" <?= $dis ?> value="100" name="b2h" <?php in_array('100', $b2h) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2i = explode(',', $data->b2i); ?>
                                        <input type="checkbox" id="nilai69" <?= $dis ?> value="0" name="b2i" <?php in_array('0', $b2i) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai70" <?= $dis ?> value="100" name="b2i" <?php in_array('100', $b2i) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2j = explode(',', $data->b2j); ?>
                                        <input type="checkbox" id="nilai71" <?= $dis ?> value="0" name="b2j" <?php in_array('0', $b2j) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai72" <?= $dis ?> value="100" name="b2j" <?php in_array('100', $b2j) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2k = explode(',', $data->b2k); ?>
                                        <input type="checkbox" id="nilai73" <?= $dis ?> value="0" name="b2k" <?php in_array('0', $b2k) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai74" <?= $dis ?> value="100" name="b2k" <?php in_array('100', $b2k) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2l = explode(',', $data->b2l); ?>
                                        <input type="checkbox" id="nilai75" <?= $dis ?> value="0" name="b2l" <?php in_array('0', $b2l) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai76" <?= $dis ?> value="100" name="b2l" <?php in_array('100', $b2l) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2m = explode(',', $data->b2m); ?>
                                        <input type="checkbox" id="nilai77" <?= $dis ?> value="0" name="b2m" <?php in_array('0', $b2m) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai78" <?= $dis ?> value="100" name="b2m" <?php in_array('100', $b2m) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2n = explode(',', $data->b2n); ?>
                                        <input type="checkbox" id="nilai79" <?= $dis ?> value="0" name="b2n" <?php in_array('0', $b2n) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai80" <?= $dis ?> value="100" name="b2n" <?php in_array('100', $b2n) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2o = explode(',', $data->b2o); ?>
                                        <input type="checkbox" id="nilai81" <?= $dis ?> value="0" name="b2o" <?php in_array('0', $b2o) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai82" <?= $dis ?> value="100" name="b2o" <?php in_array('100', $b2o) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2p = explode(',', $data->b2p); ?>
                                        <input type="checkbox" id="nilai83" <?= $dis ?> value="0" name="b2p" <?php in_array('0', $b2p) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai84" <?= $dis ?> value="100" name="b2p" <?php in_array('100', $b2p) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">6%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $b2q = explode(',', $data->b2q); ?>
                                        <input type="checkbox" id="nilai85" <?= $dis ?> value="0" name="b2q" <?php in_array('0', $b2q) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai86" <?= $dis ?> value="100" name="b2q" <?php in_array('100', $b2q) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">5%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bba = explode(',', $data->bba); ?>
                                        <input type="checkbox" id="nilai87" <?= $dis ?> value="0" name="bba" <?php in_array('0', $bba) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai88" <?= $dis ?> value="100" name="bba" <?php in_array('100', $bba) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">10%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb1 = explode(',', $data->bb1); ?>
                                        <input type="checkbox" id="nilai89" <?= $dis ?> value="0" name="bb1" <?php in_array('0', $bb1) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai90" <?= $dis ?> value="100" name="bb1" <?php in_array('100', $bb1) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb2 = explode(',', $data->bb2); ?>
                                        <input type="checkbox" id="nilai91" <?= $dis ?> value="0" name="bb2" <?php in_array('0', $bb2) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai92" <?= $dis ?> value="100" name="bb2" <?php in_array('100', $bb2) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb3 = explode(',', $data->bb3); ?>
                                        <input type="checkbox" id="nilai93" <?= $dis ?> value="0" name="bb3" <?php in_array('0', $bb3) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai94" <?= $dis ?> value="100" name="bb3" <?php in_array('100', $bb3) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb4 = explode(',', $data->bb4); ?>
                                        <input type="checkbox" id="nilai95" <?= $dis ?> value="0" name="bb4" <?php in_array('0', $bb4) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai96" <?= $dis ?> value="100" name="bb4" <?php in_array('100', $bb4) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb5 = explode(',', $data->bb5); ?>
                                        <input type="checkbox" id="nilai97" <?= $dis ?> value="0" name="bb5" <?php in_array('0', $bb5) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai98" <?= $dis ?> value="100" name="bb5" <?php in_array('100', $bb5) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb6 = explode(',', $data->bb6); ?>
                                        <input type="checkbox" id="nilai99" <?= $dis ?> value="0" name="bb6" <?php in_array('0', $bb6) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai100" <?= $dis ?> value="100" name="bb6" <?php in_array('100', $bb6) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">7%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb7 = explode(',', $data->bb7); ?>
                                        <input type="checkbox" id="nilai101" <?= $dis ?> value="0" name="bb7" <?php in_array('0', $bb7) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai102" <?= $dis ?> value="100" name="bb7" <?php in_array('100', $bb7) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb8 = explode(',', $data->bb8); ?>
                                        <input type="checkbox" id="nilai103" <?= $dis ?> value="0" name="bb8" <?php in_array('0', $bb8) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai104" <?= $dis ?> value="100" name="bb8" <?php in_array('100', $bb8) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb9 = explode(',', $data->bb9); ?>
                                        <input type="checkbox" id="nilai105" <?= $dis ?> value="0" name="bb9" <?php in_array('0', $bb9) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai106" <?= $dis ?> value="100" name="bb9" <?php in_array('100', $bb9) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb10 = explode(',', $data->bb10); ?>
                                        <input type="checkbox" id="nilai107" <?= $dis ?> value="0" name="bb10" <?php in_array('0', $bb10) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai108" <?= $dis ?> value="100" name="bb10" <?php in_array('100', $bb10) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb11 = explode(',', $data->bb11); ?>
                                        <input type="checkbox" id="nilai109" <?= $dis ?> value="0" name="bb11" <?php in_array('0', $bb11) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai110" <?= $dis ?> value="100" name="bb11" <?php in_array('100', $bb11) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bb12 = explode(',', $data->bb12); ?>
                                        <input type="checkbox" id="nilai111" <?= $dis ?> value="0" name="bb12" <?php in_array('0', $bb12) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai112" <?= $dis ?> value="100" name="bb12" <?php in_array('100', $bb12) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">8%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bba1 = explode(',', $data->bba1); ?>
                                        <input type="checkbox" id="nilai113" value="50" name="bba1" <?php in_array('50', $bba1) ? print "checked" : ""; ?> onclick="hitung()">
                                        < 3 orang <br><input type="checkbox" id="nilai114" <?= $dis ?> value="75" name="bba1" <?php in_array('75', $bba1) ? print "checked" : ""; ?> onclick="hitung()"> 3 -5 orang <br>
                                            <input type="checkbox" id="nilai115" <?= $dis ?> value="100" name="bba1" <?php in_array('100', $bba1) ? print "checked" : ""; ?> onclick="hitung()"> >5 orang
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bbb = explode(',', $data->bbb); ?>
                                        <input type="checkbox" id="nilai116" <?= $dis ?> value="0" name="bbb" <?php in_array('0', $bbb) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai117" <?= $dis ?> value="100" name="bbb" <?php in_array('100', $bbb) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bbc = explode(',', $data->bbc); ?>
                                        <input type="checkbox" id="nilai118" <?= $dis ?> value="0" name="bbc" <?php in_array('0', $bbc) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai119" <?= $dis ?> value="100" name="bbc" <?php in_array('100', $bbc) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">17%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bbd = explode(',', $data->bbd); ?>
                                        <input type="checkbox" id="nilai120" <?= $dis ?> value="0" name="bbd" <?php in_array('0', $bbd) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai121" <?= $dis ?> value="100" name="bbd" <?php in_array('100', $bbd) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">16%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bbe = explode(',', $data->bbe); ?>
                                        <input type="checkbox" id="nilai122" <?= $dis ?> value="0" name="bbe" <?php in_array('0', $bbe) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai123" <?= $dis ?> value="100" name="bbe" <?php in_array('100', $bbe) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">17%</td>
                                ...
                                <tr>
                                    ...
                                    <td width="20%">
                                        <?php $bbf = explode(',', $data->bbf); ?>
                                        <input type="checkbox" id="nilai124" <?= $dis ?> value="0" name="bbf" <?php in_array('0', $bbf) ? print "checked" : ""; ?> onclick="hitung()"> tidak ada <br>
                                        <input type="checkbox" id="nilai125" <?= $dis ?> value="100" name="bbf" <?php in_array('100', $bbf) ? print "checked" : ""; ?> onclick="hitung()"> ada
                                    </td>
                                    <td></td>
                                    <td align="center">17%</td>
                        ...
                        <form method="post" action="<?php echo base_url() ?>askk/Hasil_kredensialing_nyeri/updateStatus/<?= $data->id_checkbox ?>">
                            <table class="table table-striped">
                                <?php if ($this->session->login_session['role'] == 'admin') { ?>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="radio-toolbar">
                                                ...
                                                <input type="radio" class="terima" id="terima" <?= $dis ?> name="penilaian" <?php in_array('terimakabid', $penilaian) ? print "checked" : ""; ?> value="terima">
                                                <label for="terima">Terima</label>

                                                <input type="radio" class="tolak" id="tolak" <?= $dis ?> name="penilaian" <?php in_array('tolakkabid', $penilaian) ? print "checked" : ""; ?> value="tolak">
                                    ...
                                    <tr>
                                        <?php if ($this->session->login_session['role'] == 'admin') { ?>
                                            <td><button type="submit" onclick="return confirm('Yakin ingin menyimpan data?')" class="btn btn-success">Simpan</button></td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
                            </table>
                        ...
                        <form method="post" action="<?php echo base_url() ?>askk/Hasil_kredensialing_nyeri/updateStatuskabid/<?= $data->id_checkbox ?>">
