            ...
            <div class="row">
                <div class="col">
                    <h4 class="h5 align-middle m-0 font-weight-bold text-primary">
                        Data Hasil Penilaian Pengajuan Layanan Baru Poli Nyeri
                    </h4>
                </div>
                <!-- <div class="col-auto">
                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?= $j['tgl']; ?></td>
                                <td><?= $j['hasilSkor']; ?></td>
                                <td><a href="<?= base_url('upload/askk/' . $j['dokumen']) ?>" class="btn btn-primary btn-sm m-b-10 m-l-5" target="_blank">Lihat</a></td>
                                <td><?= $j['hasilBpjs']; ?></td>
                                <td><?= $j['tgKreon']; ?></td>
