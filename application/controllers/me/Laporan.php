...
class Laporan extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('transaksi', 'Laporan', 'required|in_list[kreon_tm,kreon_doc]');
        $this->form_validation->set_rules('tanggal', 'Periode Tanggal', 'required');

        if ($this->form_validation->run() == false) {
            $data['title'] = "Laporan Kredensialing Rumah Sakit";
            ...
            $this->load->view('viewsKreon/laporan/form', $data);
            ...
            $query = '';
            if ($table == 'kreon_tm') {
                $query = $this->admin->getLaporanKredensialingRS(null, null, ['mulai' => $mulai, 'akhir' => $akhir]);
            } else {
                $query = $this->admin->getLaporanDokumenRS(null, null, ['mulai' => $mulai, 'akhir' => $akhir]);
            }
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        $table = $table_ == 'kreon_tm' ? 'Kredensialing Tenaga Medis Rumah Sakit' : 'Dokumen Kredensialing Rumah Sakit';
