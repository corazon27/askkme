...
class Profile extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('viewsKreon/profile/user', $data);
    ...
    public function setting()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('viewsKreon/templates/sidebar', $data);
            $this->load->view('viewsKreon/templates/topbar', $data);
            $this->load->view('viewsKreon/profile/setting', $data);
            $this->load->view('viewsKreon/templates/footer');
        } else {
            ...
            if (empty($_FILES['foto']['name'])) {
                ...
                if ($insert) {
                    ...
                    if ($this->upload->do_upload('foto')) {
                        ...
                        $config['new_image'] = './assets/img/avatar/' . $image_data['file_name'];
                        ...
                        if ($this->image_lib->resize()) {
                            ...
                            echo base_url('assets/img/avatar/' . $image_data['file_name']);
                        } else {
    ...
    public function ubahpassword()
    {
        ...
        $this->form_validation->set_rules('password_baru', 'Password Baru', 'required|trim|min_length[8]|differs[password_lama]');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('viewsKreon/templates/sidebar', $data);
            $this->load->view('viewsKreon/templates/topbar', $data);
            $this->load->view('viewsKreon/profile/ubahpassword', $data);
            $this->load->view('viewsKreon/templates/footer');
        } else {
            $input = $this->input->post(null, true);
            ...
            redirect('me/profile/ubahpassword');
        }
    }
}
