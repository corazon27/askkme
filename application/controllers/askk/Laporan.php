...
class Laporan extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('transaksi', 'Laporan', 'required|in_list[checkbox]');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $query = $this->admin->getLaporanKredensialingNyeri(null, null, ['mulai' => $mulai, 'akhir' => $akhir]);
    ...
    private function _cetak($data, $table, $tanggal)
    {
        ...
        $table = 'Kredensialing Poli Nyeri';
